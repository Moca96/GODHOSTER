...
from Venom.plugins.repo import eor
eod = eor
parse_error = eor
...
@events.register(events.NewMessage(outgoing=True, pattern="^.inviteall"))
...
@events.register(events.NewMessage(outgoing=True, pattern="^.add"))
async def add(event):
