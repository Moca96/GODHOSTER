hn = "."
spamusage = f"**🚫Wʀᴏɴɢ Usᴀɢᴇ🚫**\n\nUsᴇ: ```{hn}help``` Tᴏ ᴋɴᴏᴡ ᴜsᴀɢᴇ ᴏғ ᴀʟʟ sᴘᴀᴍ ᴄᴏᴍᴍᴀɴᴅs."
devusage = f"**🚫Wʀᴏɴɢ Usᴀɢᴇ🚫**\n\nUsᴇ: ```{hn}help``` Tᴏ ᴋɴᴏᴡ ᴜsᴀɢᴇ ᴏғ ᴀʟʟ ᴅᴇᴠ ᴄᴏᴍᴍᴀɴᴅs."
sudousage = f"**🚫Wʀᴏɴɢ Usᴀɢᴇ🚫**\n\nUsᴇ: ```{hn}help``` Tᴏ ᴋɴᴏᴡ ᴜsᴀɢᴇ ᴏғ ᴀʟʟ sᴜᴅᴏ ᴄᴏᴍᴍᴀɴᴅs."
accusage = f"**🚫Wʀᴏɴɢ Usᴀɢᴇ🚫**\n\nUsᴇ: ```{hn}help``` Tᴏ ᴋɴᴏᴡ ᴜsᴀɢᴇ ᴏғ ᴀʟʟ ᴀᴄᴄᴏᴜɴᴛ ᴄᴏᴍᴍᴀɴᴅs."
...
alive_temxt = start_caption1
start_caption = start_caption1
